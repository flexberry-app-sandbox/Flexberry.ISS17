...
namespace IIS.ISS17
{
    ...
    public class ВидПоддержки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ISS17.DetailArrayOfУсловие fУсловие;
        ...
        public virtual IIS.ISS17.DetailArrayOfУсловие Условие
        {
            get
            {
                ...
                {
                    this.fУсловие = new IIS.ISS17.DetailArrayOfУсловие(this);
                }
                IIS.ISS17.DetailArrayOfУсловие result = this.fУсловие;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВидПоддержкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидПоддержкиE", typeof(IIS.ISS17.ВидПоддержки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВидПоддержкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидПоддержкиL", typeof(IIS.ISS17.ВидПоддержки));
                }
            }
        }
    }
